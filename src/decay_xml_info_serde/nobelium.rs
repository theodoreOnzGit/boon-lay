...
fn serde_nuclide_test() {
  ...
  "#;
        ...
        use crate::decay_xml_info_serde::nobelium::get_nobelium_xml_serde_data;
        assert_eq!(nuclides,get_nobelium_xml_serde_data());
...
use crate::decay_xml_info_serde::SerdeNuclideVec;
pub fn get_nobelium_xml_serde_data() -> SerdeNuclideVec {
