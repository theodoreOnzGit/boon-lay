...
fn serde_nuclide_test() {
  ...
  "#;
        ...
        use crate::decay_xml_info_serde::hassium::get_hassium_xml_serde_data;
        assert_eq!(nuclides,get_hassium_xml_serde_data());
...
use crate::decay_xml_info_serde::SerdeNuclideVec;
pub fn get_hassium_xml_serde_data() -> SerdeNuclideVec {
