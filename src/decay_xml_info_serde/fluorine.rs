...
fn serde_nuclide_test() {
  ...
  "#;
        ...
        use crate::decay_xml_info_serde::fluorine::get_fluorine_xml_serde_data;
        assert_eq!(nuclides,get_fluorine_xml_serde_data());
...
use crate::decay_xml_info_serde::SerdeNuclideVec;
pub fn get_fluorine_xml_serde_data() -> SerdeNuclideVec {
