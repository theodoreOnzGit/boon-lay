...
<nuclides>
  ...
  "#;
        ...
        use crate::decay_xml_info_serde::helium::get_helium_xml_serde_data;
        assert_eq!(nuclides,get_helium_xml_serde_data());
...
use crate::decay_xml_info_serde::SerdeNuclideVec;
pub fn get_helium_xml_serde_data() -> SerdeNuclideVec {
