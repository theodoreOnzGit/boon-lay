...
fn serde_nuclide_test() {
  ...
  "#;
        ...
        use crate::decay_xml_info_serde::oxygen::get_oxygen_xml_serde_data;
        assert_eq!(nuclides,get_oxygen_xml_serde_data());
...
use crate::decay_xml_info_serde::SerdeNuclideVec;
pub fn get_oxygen_xml_serde_data() -> SerdeNuclideVec {
