...
1. Release Fraction calculator plus graphing 
2. Change the Graphics for the TRISO (Always needed to scroll too far in)
3. Change the slider for timestep control (900s is quite fast), need to 
reduce maximum timestep to 1500s. no Log scale
...
6. Default timestep should be much lower 
